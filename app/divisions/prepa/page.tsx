      ...
      <div className="mx-auto max-w-4xl">
        ...
        <header className="rounded-xl bg-gradient-to-r from-white via-blue-50 to-white border border-gray-100 p-6 mb-8 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h1 className="text-3xl font-semibold text-gray-900">Prepa Division</h1>
              <p className="mt-1 text-sm text-gray-500">Math&Maroc</p>
              <p className="mt-3 text-gray-700">
                Supporting talented students in preparatory classes toward excellence — video capsules, mock orals, TIPE, and mentoring.
              </p>
        ...
        <section className="grid gap-4 sm:grid-cols-2 mb-8">
          <div className="rounded-lg bg-white p-5 border border-gray-100 shadow-sm">
            <h3 className="text-lg font-semibold text-gray-900">Educational Video Capsules</h3>
            ...
            <div className="mt-3 flex items-center gap-3 text-sm text-gray-500">
              <span className="inline-flex items-center gap-2 rounded-full bg-primary-50 px-2.5 py-1 text-primary-700">Videos</span>
              <span>Edited & commented content</span>
            </div>
          </div>

          <div className="rounded-lg bg-white p-5 border border-gray-100 shadow-sm">
            <h3 className="text-lg font-semibold text-gray-900">Mock Orals</h3>
            <p className="mt-2 text-gray-700 text-sm">
              Simulations with alumni from top schools for real and actionable feedback.
            </p>
            <div className="mt-3 flex items-center gap-3 text-sm text-gray-500">
              <span className="inline-flex items-center gap-2 rounded-full bg-primary-50 px-2.5 py-1 text-primary-700">120+ students</span>
              <span>previous edition</span>
            </div>
          </div>

          <div className="rounded-lg bg-white p-5 border border-gray-100 shadow-sm">
            <h3 className="text-lg font-semibold text-gray-900">Mock T.I.P.E.</h3>
            <p className="mt-2 text-gray-700 text-sm">
          ...
          <div className="rounded-lg bg-white p-5 border border-gray-100 shadow-sm">
            <h3 className="text-lg font-semibold text-gray-900">Mentoring</h3>
            <p className="mt-2 text-gray-700 text-sm">
        ...
        <section className="mb-8">
          ...
          <ol className="space-y-6">
            <li className="flex gap-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Watch — Strengthen</h3>
          ...
          <details className="group rounded-lg border border-gray-100 bg-white p-4 shadow-sm">
            ...
            <div className="mt-3 text-gray-700 text-sm space-y-2">
              ...
              <ul className="list-disc pl-5">
                <li>Strengthen the foundations of the official curriculum</li>
        ...
        <section className="rounded-lg border border-gray-100 bg-white p-6 shadow-sm mb-12">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <p className="text-sm text-gray-500">Want to know more?</p>
          ...
          <div className="mt-4 grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              <div className="text-2xl font-semibold text-primary-600">Mentoring</div>
