...
export default function Page() {
  const divisions = [
    ...
    },
    {
      ...
      desc: "Entraînement des meilleurs lycéens marocains pour IMO, PAMO et compétitions internationales. Identification, formation et mentorat par d'anciens médaillés.",
    },
    {
      slug: 'orientation',
      title: 'Orientation',
    ...
    },
    {
      ...
      desc: 'Placeholder: Physics Olympiads activities, training and selection.',
    },
    {
      slug: 'prepa',
      title: 'Pôle Prépa',
      desc: 'Accompagner les talents des classes préparatoires vers l’excellence — capsules, oraux, TIPE et mentorat.',
    },
  ];
